...
const BYTECODE = "";
...
async function main() {
  ...
  if (!deployerKey || !agentKey) {
    throw new Error("DEPLOYER_PRIVATE_KEY and AI_AGENT_PRIVATE_KEY must be set");
  }
  ...
  if (balance === 0n) {
    console.error("ERROR: Deployer wallet has 0 CELO. Fund it at https://faucet.celo.org before deploying.");
    process.exit(1);
  }
